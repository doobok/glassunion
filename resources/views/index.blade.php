...
@section('head')
  @component('components.meta')
    ...
    @slot('description') Купить окна в Буче недорого по цене от 2 000 грн. ◈ В наличии широкий ассортимент наименований. Доставка по Буче и региону ✓ Интернет-магазин Glassunion ☎ +38(066)522-90-66 (пн-пт с 10:00 до 19:00)
    @endslot
